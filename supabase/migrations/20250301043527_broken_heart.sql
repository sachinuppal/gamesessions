/*
  # Codenames Game Schema Update

  This migration ensures the codenames tables and policies exist without conflicts.
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'codenames_sessions' AND policyname = 'Allow public read access to codenames_sessions') THEN
    EXECUTE 'CREATE POLICY "Allow public read access to codenames_sessions" ON codenames_sessions FOR SELECT TO public USING (true)';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'codenames_sessions' AND policyname = 'Allow public insert access to codenames_sessions') THEN
    EXECUTE 'CREATE POLICY "Allow public insert access to codenames_sessions" ON codenames_sessions FOR INSERT TO public WITH CHECK (true)';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'codenames_sessions' AND policyname = 'Allow public update access to codenames_sessions') THEN
    EXECUTE 'CREATE POLICY "Allow public update access to codenames_sessions" ON codenames_sessions FOR UPDATE TO public USING (true)';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'codenames_players' AND policyname = 'Allow public read access to codenames_players') THEN
    EXECUTE 'CREATE POLICY "Allow public read access to codenames_players" ON codenames_players FOR SELECT TO public USING (true)';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'codenames_players' AND policyname = 'Allow public insert access to codenames_players') THEN
    EXECUTE 'CREATE POLICY "Allow public insert access to codenames_players" ON codenames_players FOR INSERT TO public WITH CHECK (true)';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'codenames_players' AND policyname = 'Allow public update access to codenames_players') THEN
    EXECUTE 'CREATE POLICY "Allow public update access to codenames_players" ON codenames_players FOR UPDATE TO public USING (true)';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'codenames_rounds' AND policyname = 'Allow public read access to codenames_rounds') THEN
    EXECUTE 'CREATE POLICY "Allow public read access to codenames_rounds" ON codenames_rounds FOR SELECT TO public USING (true)';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'codenames_rounds' AND policyname = 'Allow public insert access to codenames_rounds') THEN
    EXECUTE 'CREATE POLICY "Allow public insert access to codenames_rounds" ON codenames_rounds FOR INSERT TO public WITH CHECK (true)';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'codenames_rounds' AND policyname = 'Allow public update access to codenames_rounds') THEN
    EXECUTE 'CREATE POLICY "Allow public update access to codenames_rounds" ON codenames_rounds FOR UPDATE TO public USING (true)';
  END IF;
EXCEPTION
  WHEN OTHERS THEN
